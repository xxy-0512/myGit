 ...
 * @Author: maojunjun
 * @Description:
 * @Date: Created in 12:04 2019/1/12
 */
public class CalculateWallet {

    /**
     * 计算每人获得红包金额;最小每人0.01元
     * @param sendMoney 红包总额
     * @param number 人数
     * @return
     */
    public static List<BigDecimal> math(BigDecimal sendMoney, int number) {
        if (sendMoney.doubleValue() < number * 0.01) {
            return null;
        }
        Random random = new Random();
        // 金钱，按分计算 10块等于 1000分
        int money = sendMoney.multiply(BigDecimal.valueOf(100)).intValue();
        // 随机数总额
        double count = 0;
        // 每人获得随机点数
